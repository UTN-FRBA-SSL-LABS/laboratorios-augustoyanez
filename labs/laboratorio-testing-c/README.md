...
> R: Deja el carrito en estado inicial vacío, poniendo su contador de ítems
...
> R: El unitario prueba una función aislada  el de integración verifica varias funciones combinadas
...
> R: no verifica límites de arrays: escribir en items[4] pisa memoria adyacente sin error
...
> R: os tests verifican el comportamiento real y quedan como red de seguridad ante cambios
...
> R: Porque con un solo producto de cantidad 1 el resultado correcto y el incorrecto coinciden: el bug omitía multiplicar por cantidad, y multiplicar por 1 no cambia nada (350 en ambos casos). Recién con cantidad 2 los valores se separan (700 vs 350) y el test falla.
